...
class MainContainer extends Component {
  render() {
    console.log('main container props', this.props.toggleDialog);
    return(
      <div className="container">
        <div className="outerBox">
          <h1 id="header">The Codesmith Family</h1>
          <OuterIris/>
          <Button id="dialog-button" variant="contained" onClick={ this.props.toggleDialog } >Create Profile</Button>
